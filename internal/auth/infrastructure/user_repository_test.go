...
func TestRepository_GetUserByEmail_Success(t *testing.T) {
	...
	got, err := env.repo.GetUserByEmail(context.Background(), "user@example.com")
...
func TestRepository_GetUserByEmail_NotFound(t *testing.T) {
	...
	_, err := env.repo.GetUserByEmail(context.Background(), "missing@example.com")
...
func TestRepository_GetUserByEmail_NilContext(t *testing.T) {
	...
	user, err := env.repo.GetUserByEmail(ctx, "nilctx@example.com")

	assert.NoError(t, err)
	assert.Equal(t, "nilctx@example.com", user.Email)
}
